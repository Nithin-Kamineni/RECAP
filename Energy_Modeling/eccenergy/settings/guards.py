...
GUARDS = {
    ...
    "sweep-has-no-figure":      _g(2, "a sweep or panel FIGURE on an axis in settings/run.py's NO_FIGURE_SWEEPS (EMPTY since 2026-09-15: area got a renderer)"),
    "depth-ladder-empty":       _g(2, "ECC_SWEEP=area with an empty ECC_DEPTH_SWEEP_SCALES -- an x axis with no points"),
