...
| `TaskD_MapTheTwoDesigns.md` | phase 6's leftover: `simple_weight_stationary` and `eyeriss_v2_like_wglb` mapped at scope, their figures, and FINDINGS 2.11's numbers | **OPEN** — ONE DESIGN PER SESSION: 1 `simple_weight_stationary`, 2 `eyeriss_v2_like_wglb`, 3 the three-panel figure |
